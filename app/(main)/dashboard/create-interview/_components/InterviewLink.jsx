...
function InterviewLink({ interview_id, formData }) {
  ...
  return (
    <div className='flex flex-col items-center justify-center mt-10'>
      ...
      <p className='mt-3'>Share this link with your candidates to start with the interview process</p>
      ...
      <div className='w-full p-7 mt-6 rounded-lg bg-white'>
        ...
        <div className='mt-3 flex gap-3 items-center'>
          <Input defaultValue={GetInterviewUrl(url)} disabled={true} />
          <Button onClick={() => onCopyLink(url)}> <Copy /> Copy Link </Button>
        </div>
        <hr className='my-5' />

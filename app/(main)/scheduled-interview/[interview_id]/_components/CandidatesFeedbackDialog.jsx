...
function CandidatesFeedbackDialog({candidate}) {
        ...
        <div className='mt-5'>
            ...
            <div className='flex items-center gap-5'>
                ...
                <div>
                    ...
                    <h2 className='text-sm text-gray-500'>{candidate?.useEmail}</h2>
                    </div>  
                </div> 
                ...
                <div className='mt-5'>
                    ...
                    <div className='mt-3 grid grid-cols-2 gap-10'>
                        <div>
                            <h2 className='flex justify-between'>Technical Skill <span>{feedback?.rating?.techicalSkills}/10</span></h2>
                ...
                <div className={`p-5 mt-10 flex items-center justify-between rounded-md ${feedback?.Recommendation =='No' ? 'bg-red-100':'bg-green-100'}`}>
                    <div>
                        ...
                        <p className={`${feedback?.Recommendation == 'No'?'text-red-500' : 'text-green-500'}`}></p>
                    </div>
...
export default CandidatesFeedbackDialog
